...
export default function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="bg-cream border-l border-brand-300 px-10 py-16 text-center flex flex-col items-center">
        ...
        <h3 className="font-display font-light text-brand-600 text-3xl mb-4">Message received</h3>
  ...
  return (
    <div className="bg-cream border-l border-brand-300 px-8 sm:px-12 py-12">
      ...
      <h3 className="font-display font-light text-brand-600 text-3xl mb-3">Send us a message</h3>
